...
1. เมื่อมีการแสกนครั้งใหม่ในกะถัดไป ระบบจะตรวจสอบ Record ล่าสุดของพนักงานคนนั้น
2. หากพบว่าแสกนของวันก่อนหน้ายังไม่มีเวลาออก (`TimeOut IS NULL`) ระบบจะทำการ **ปิดกะเก่าให้โดยอัตโนมัติ**
3. โดยจะดึงเวลา **เวลาเลิกงานตามแผน (OutTmp)** จากตารางกะงานมาบันทึกให้ และระบุ IP เป็น `AUTO_CLEANUP`
4. จากนั้นจึงจะดำเนินขั้นตอนบันทึกการแสกนใหม่ตามปกติ (INSERT แถวใหม่)
